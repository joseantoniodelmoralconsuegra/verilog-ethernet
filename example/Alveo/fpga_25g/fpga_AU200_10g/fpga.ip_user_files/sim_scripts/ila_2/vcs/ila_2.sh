...
#
# Script generated by Vivado on Mon Jul 29 20:41:23 CEST 2024
...
# script info
echo -e "ila_2.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../fpga.gen/sources_1/ip/ila_2/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../fpga.gen/sources_1/ip/ila_2/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/joseantonio/TFM/verilog-ethernet-toqueteo-190724/verilog-ethernet/example/Alveo/fpga_25g/fpga_AU200_10g/fpga.cache/compile_simlib/vcs"
  fi
