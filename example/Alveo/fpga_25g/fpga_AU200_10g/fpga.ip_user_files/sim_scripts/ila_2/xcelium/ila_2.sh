...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../fpga.gen/sources_1/ip/ila_2/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../fpga.gen/sources_1/ip/ila_2/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/joseantonio/TFM/verilog-ethernet-toqueteo-190724/verilog-ethernet/example/Alveo/fpga_25g/fpga_AU200_10g/fpga.cache/compile_simlib/xcelium"
  fi
